...
{
    extract(apply_filters('veekls_api_client_format_price_args', wp_parse_args($args, array(
    ...
    $price = apply_filters('veekls_api_client_formatted_price', number_format($price, $decimals, $decimal_separator, $thousand_separator), $price, $decimals, $decimal_separator, $thousand_separator);
...
{
    return strip_tags(veekls_api_client_format_price($price));
}
